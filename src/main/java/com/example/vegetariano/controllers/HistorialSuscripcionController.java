...
public class HistorialSuscripcionController {
    ...
    public List<HistorialSuscripcionDTO> listar() {
        return hSU.list().stream().map(x -> {
            ModelMapper m = new ModelMapper();
            return m.map(x, HistorialSuscripcionDTO.class);
    ...
    public ResponseEntity<QuerySuscripcionActivaDTO> compararSuscripciones() {
        QuerySuscripcionActivaDTO dto = hSU.findSuscripcionesActivas();
