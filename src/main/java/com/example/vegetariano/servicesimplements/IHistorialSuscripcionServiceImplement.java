...
public class IHistorialSuscripcionServiceImplement implements IHistorialSuscripcionService {
    ...
    @Override
    public QuerySuscripcionActivaDTO findSuscripcionesActivas() {
        Object[] resultado = (Object[]) hSU.obtenerComparacionActivasInactivas();

        long activos = ((Number) resultado[0]).longValue();
        long inactivos = ((Number) resultado[1]).longValue();

        return new QuerySuscripcionActivaDTO(activos, inactivos);
    }
}
